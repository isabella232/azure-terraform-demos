# Azure Terraform PoC (KeyVault / Secret)
...
Azure Service URL: [https://azure.microsoft.com/pt-br/services/frontdoor/](https://azure.microsoft.com/pt-br/services/frontdoor/)
...
**Change main.tf adding your user id at owner_object_id, so you will have access to the KeyVault.**
...
terraform apply
```
After the terraform apply finishes you can go to the KeyVault service and check the Secret.
