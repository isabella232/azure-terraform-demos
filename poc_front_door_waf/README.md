# Azure Terraform PoC (Web App Service / Front Door / WAF)
...
Normal access: https://poc04-frontdoor-us-dev.azurefd.net  
Malicious URL will be blocked by WAF: https://poc04-frontdoor-us-dev.azurefd.net?injection=--insert  
