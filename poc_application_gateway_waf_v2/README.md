# Azure Terraform PoC (Application Gateway / WAF version 2)
...
Difference between WAF_v1 and WAF_v2: [https://docs.microsoft.com/en-us/azure/application-gateway/application-gateway-autoscaling-zone-redundant#feature-comparison-between-v1-sku-and-v2-sku](https://docs.microsoft.com/en-us/azure/application-gateway/application-gateway-autoscaling-zone-redundant#feature-comparison-between-v1-sku-and-v2-sku)
...
* Access from Brazil will be blocked as an example
...
Access from Brazil will be blocked by WAF  
